...
_('Decree')
_('Directive')
_('Executive Instrument')
_('General Notice')
_('Government Notice')
_('Guidance Note')
_('Guidelines')
_('Hansard')
_('High Commissioners Notice')
_('Instructions')
_('Instructions of the Registrar General')
_('Kings Order in Council')
_('Law')
_('Legal Notice')
_('Legislative Instrument')
_('Local Authority Notice')
_('Measure')
_('Ministerial Instructions')
_('Ministerial Order')
_('Model Law')
_('Municipal Notice')
_('Official Notice')
...
_('Organic Law')
_('Pact')
_('Practice Direction')
_('Premiers Notice')
_('Presidential Order')
_('Prime Ministers Order')
_('Proclamation')
_('Proposal')
_('Protocol')
_('Provincial Notice')
