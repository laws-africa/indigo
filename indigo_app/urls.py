...
urlpatterns = [
    ...
    path('places/<str:place>/tasks/facets', cache_page(30)(tasks.TaskFacetsView.as_view()), name='tasks_facets'),
    ...
    re_path(r'^works(?P<frbr_uri>/\S+?)/form/commencements-made$', works.WorkFormCommencementsView.as_view(), name='work_form_commencements_made'),
