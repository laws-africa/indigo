(function(exports) {
  ...
  class SlawGrammarModel extends indigoAkn.GrammarModel {
    constructor (...args) {
      super(...args);
    ...
    installActions (editor) {
      editor.addAction({
        ...
        run: function(editor) {
          editor.pushUndoStop();
          indigoAkn.wrapSelection(editor, 'format.bold', '**', '**');
          editor.pushUndoStop();
        }
      });
      ...
      editor.addAction({
        ...
        run: function(editor) {
          editor.pushUndoStop();
          indigoAkn.wrapSelection(editor, 'format.italics', '//', '//');
          editor.pushUndoStop();
        }
      });
      ...
      editor.addAction({
        ...
        run: function(editor) {
          editor.pushUndoStop();
          indigoAkn.wrapSelection(editor, 'format.remark', '[[', ']]');
          editor.pushUndoStop();
        }
      });
