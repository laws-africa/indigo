...
urlpatterns = [
    ...
    # re_path(r'^works(?P<frbr_uri>/\S+?)/commencements/(?P<pk>\d+)/refresh-timeline$', works.WorkCommencementDetailView.as_view(refresh_timeline=True), name='work_commencement_detail_refresh_timeline'),
    ...
    # re_path(r'^works(?P<frbr_uri>/\S+?)/commencements/(?P<pk>\d+)/edit-commencing-work$', works.WorkCommencementEditCommencingWorkView.as_view(), name='work_commencement_edit_commencing_work'),
