...
urlpatterns = [
    ...
    path('documents/<int:document_id>/revisions/<int:pk>/diff', cache_control(private=True, max_age=24 * 3600)(documents.RevisionDiffView.as_view()), name='document-revisions-diff'),
