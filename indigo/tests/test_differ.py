...
<span class="akn-content"
  ...
  ><span
    ...
    >"<span
      ...
      >Court</span
    >" means a provincial or local division of the Supreme Court of South Africa or the High Court of South-West Africa or any judge thereof;</span
  ><span
    class="akn-p"
