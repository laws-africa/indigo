...
urlpatterns = [
    ...
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/works/facets$', places.PlaceWorksFacetsView.as_view(), name='place_works_facets'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/works/actions$', places.WorkActionsView.as_view(), name='place_works_actions'),
    path('places/<str:place>/works/detail/<int:pk>', places.WorkDetailView.as_view(),
         name='place_works_work_detail'),
    path('places/<str:place>/works/detail/<int:pk>/commencements', places.WorkCommencementsView.as_view(),
         name='place_works_work_commencements'),
    path('places/<str:place>/works/detail/<int:pk>/amendments', places.WorkAmendmentsView.as_view(),
         name='place_works_work_amendments'),
    ...
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/users', places.PlaceUsersView.as_view(), name='place_users'),
    ...
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/tasks/(?P<pk>\d+)/blocking-tasks', tasks.TaskChangeBlockingTasksView.as_view(), name='task_blocked_by'),
