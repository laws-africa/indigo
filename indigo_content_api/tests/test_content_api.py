...
class PublishedAPITest(APITestCase):
    ...
    def test_published_json_perms(self):
        ...
        response = self.client.get('/api/v1/za/act/2014/10')
    ...
    def test_published_json(self):
        ...
        response = self.client.get('/api/v1/za/act/2014/10.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['frbr_uri'], '/za/act/2014/10')

        response = self.client.get('/api/v1/za/act/2014/10/eng.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['frbr_uri'], '/za/act/2014/10')

    def test_published_xml(self):
        response = self.client.get('/api/v1/za/act/2014/10.xml')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/xml')
        assert_in('<akomaNtoso', response.content)

        response = self.client.get('/api/v1/za/act/2014/10/eng.xml')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/xml')
        assert_in('<akomaNtoso', response.content)
    ...
    def test_published_pdf(self, mock):
        response = self.client.get('/api/v1/za/act/2014/10.pdf')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/pdf')
        assert_in('pdf-content', response.content)

        response = self.client.get('/api/v1/za/act/2014/10/eng.pdf')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/pdf')
        assert_in('pdf-content', response.content)

    def test_published_epub(self):
        response = self.client.get('/api/v1/za/act/2014/10.epub')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/epub+zip')
        assert_true(response.content.startswith('PK'))

        response = self.client.get('/api/v1/za/act/2014/10/eng.epub')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/epub+zip')
        assert_true(response.content.startswith('PK'))

    def test_published_html(self):
        response = self.client.get('/api/v1/za/act/2014/10.html')
        assert_equal(response.status_code, 200)
        ...
        response = self.client.get('/api/v1/za/act/2014/10/eng.html')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'text/html')
        assert_not_in('<akomaNtoso', response.content)
    ...
    def test_published_html_standalone(self):
        response = self.client.get('/api/v1/za/act/2014/10.html?standalone=1')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'text/html')
        assert_not_in('<akomaNtoso', response.content)
    ...
    def test_published_listing_pdf(self, mock):
        response = self.client.get('/api/v1/za/act.pdf')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/pdf')
        assert_in('pdf-content', response.content)
    ...
    def test_published_listing_html_404(self):
        ...
        response = self.client.get('/api/v1/za/act.html')
        assert_equal(response.status_code, 404)
        assert_equal(response.accepted_media_type, 'text/html')

    def test_published_listing_pdf_404(self):
        response = self.client.get('/api/v1/za/act/bad.pdf')
        assert_equal(response.status_code, 404)

    def test_published_listing_epub_404(self):
        response = self.client.get('/api/v1/za/act/bad.epub')
        assert_equal(response.status_code, 404)

    def test_published_atom(self):
        response = self.client.get('/api/v1/za/summary.atom')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/atom+xml')

        response = self.client.get('/api/v1/za/full.atom')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/atom+xml')

        response = self.client.get('/api/v1/za/act/2014/full.atom')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/atom+xml')

    def test_published_atom_404(self):
        response = self.client.get('/api/v1/uk/summary.atom')
        assert_equal(response.status_code, 404)
        assert_equal(response.accepted_media_type, 'text/html')

    def test_published_missing(self):
        assert_equal(self.client.get('/api/v1/za/act/2999/22').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22.html').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22.xml').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22.json').status_code, 404)

        assert_equal(self.client.get('/api/v1/za/act/2999/22/eng').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22/eng.html').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22/eng.xml').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2999/22/eng.json').status_code, 404)

    def test_published_wrong_language(self):
        assert_equal(self.client.get('/api/v1/za/act/2014/10/fre').status_code, 404)
        assert_equal(self.client.get('/api/v1/za/act/2014/10/fre.html').status_code, 404)

    def test_published_listing_missing(self):
        assert_equal(self.client.get('/api/v1/za/act/2999/').status_code, 404)
        assert_equal(self.client.get('/api/v1/zm/').status_code, 404)

    def test_published_toc(self):
        response = self.client.get('/api/v1/za/act/2014/10/eng/toc.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['toc'], [
            {'id': 'section-1', 'type': 'section', 'num': '1.',
                'component': 'main', 'subcomponent': 'section/1',
                'url': 'http://testserver/api/v1/za/act/2014/10/eng/main/section/1',
                'title': 'Section 1.'}])

        response = self.client.get('/api/v1/za/act/2014/10/toc.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['toc'], [
            {'id': 'section-1', 'type': 'section', 'num': '1.',
    ...
    def test_published_toc_uses_expression_date_in_urls(self):
        # use @2014-02-12
        response = self.client.get('/api/v1/za/act/2014/10/eng@2014-02-12/toc.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['toc'], [
            {'id': 'section-1', 'type': 'section', 'num': '1.',
                'component': 'main', 'subcomponent': 'section/1',
                'url': 'http://testserver/api/v1/za/act/2014/10/eng@2014-02-12/main/section/1',
                'title': 'Section 1.'}])
...
''')
    ...
    def test_at_expression_date(self):
        ...
        # doesn't exist
        response = self.client.get('/api/v1/za/act/2011/5/eng@2099-01-01.json')
        assert_equal(response.status_code, 404)

    def test_before_expression_date(self):
        # at or before 2015-01-01
        response = self.client.get('/api/v1/za/act/2010/1/eng:2015-01-01.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['expression_date'], '2012-02-02')

        # at or before 2012-01-01
        response = self.client.get('/api/v1/za/act/2010/1/eng:2012-01-01.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['expression_date'], '2011-01-01')

        # doesn't exist
        response = self.client.get('/api/v1/za/act/2010/1/eng:2009-01-01.json')
        assert_equal(response.status_code, 404)

    def test_latest_expression(self):
        response = self.client.get('/api/v1/za/act/2010/1/eng.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
        assert_equal(response.data['expression_date'], '2012-02-02')
        ...
        assert_equal(response.data['points_in_time'], [
            {
                'date': '2011-01-01',
                'expressions': [{
                    'url': 'http://testserver/api/v1/za/act/2010/1/eng@2011-01-01',
            ...
            },
            {
                'date': '2012-02-02',
                'expressions': [{
                    'url': 'http://testserver/api/v1/za/act/2010/1/eng@2012-02-02',
    ...
    def test_published_repealed(self):
        response = self.client.get('/api/v1/za/act/2001/8/eng.json')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/json')
    ...
    def test_published_alternate_links(self):
        ...
        assert_equal(links, [
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng.xml', 'mediaType': 'application/xml', 'rel': 'alternate', 'title': 'Akoma Ntoso'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng.html', 'mediaType': 'text/html', 'rel': 'alternate', 'title': 'HTML'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng/media.json', 'mediaType': 'application/json', 'rel': 'media', 'title': 'Media'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng.pdf', 'mediaType': 'application/pdf', 'rel': 'alternate', 'title': 'PDF'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng.html?standalone=1', 'mediaType': 'text/html', 'rel': 'alternate', 'title': 'Standalone HTML'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng/toc.json', 'mediaType': 'application/json', 'rel': 'toc', 'title': 'Table of Contents'},
            {'href': 'http://testserver/api/v1/za/act/2001/8/eng.epub', 'mediaType': 'application/epub+zip', 'rel': 'alternate', 'title': 'ePUB'},
        ])
    ...
    def test_published_media_attachments(self):
        ...
        # should be empty
        response = self.client.get('/api/v1/za/act/2001/8/eng/media.json')
        assert_equal(response.status_code, 200)
        assert_equal(len(response.data['results']), 0)

        # should not exist
        response = self.client.get('/api/v1/za/act/2001/8/eng/media/test.txt')
        assert_equal(response.status_code, 404)
        ...
        response = self.client.get('/api/v1/za/act/2001/8/eng/media/bad.txt')
        assert_equal(response.status_code, 403)

    def test_published_zipfile(self):
        response = self.client.get('/api/v1/za/act/2001/8/eng.zip')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/zip')

    def test_published_zipfile_many(self):
        response = self.client.get('/api/v1/za/act/2001.zip')
        assert_equal(response.status_code, 200)
        assert_equal(response.accepted_media_type, 'application/zip')
    ...
    def test_published_frbr_urls(self):
        ...
        assert_equal(response.data['url'], 'http://testserver/api/v1/za/act/2014/10/eng@2014-02-12')
