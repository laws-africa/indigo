    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_name', models.CharField(null=True, max_length=255, blank=True, help_text="Original publication, eg. government gazette")),
                ('publication_number', models.CharField(null=True, max_length=255, blank=True, help_text="Publication's sequence number, eg. gazette number")),
                ('publication_date', models.CharField(null=True, max_length=255, blank=True, help_text="Date of publication (YYYY-MM-DD)")),
