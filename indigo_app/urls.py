...
urlpatterns = [
    ...
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/tasks/(?P<pk>\d+)/workflows', tasks.TaskChangeWorkflowsView.as_view(), name='task_workflows'),
    ...
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/$', workflows.WorkflowListView.as_view(), name='workflows'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/new$', workflows.WorkflowCreateView.as_view(), name='workflow_create'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/$', workflows.WorkflowDetailView.as_view(), name='workflow_detail'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/edit$', workflows.WorkflowEditView.as_view(), name='workflow_edit'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/tasks$', workflows.WorkflowAddTasksView.as_view(), name='workflow_add_tasks'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/close$', workflows.WorkflowCloseView.as_view(), name='workflow_close'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/reopen$', workflows.WorkflowReopenView.as_view(), name='workflow_reopen'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/delete$', workflows.WorkflowDeleteView.as_view(), name='workflow_delete'),
    re_path(r'^places/(?P<place>[a-z]{2}(-[^/]+)?)/workflows/(?P<pk>\d+)/tasks/(?P<task_pk>\d+)/remove$', workflows.WorkflowRemoveTaskView.as_view(), name='workflow_remove_task'),
