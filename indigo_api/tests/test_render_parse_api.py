...
from indigo.xmlutils import canonical_xml
from indigo_api.tests.fixtures import *  # noqa


class RenderParseAPITest(APITestCase):
    fixtures = ['languages_data', 'countries', 'user', 'editor', 'taxonomy_topics', 'work', 'published']
...
SCHEDULE Annexure B
  ...
  PARA 4.
    ...
    Fuel, including coal and gas.
        ...
        expected = '''<akomaNtoso xmlns="http://docs.oasis-open.org/legaldocml/ns/akn/3.0">
  <act name="act"><meta>
