...
urlpatterns = [
    ...
    url(r'^places/(?P<place_code>[a-z]{2}(-[^/]+)?)/works/new/$', works.AddWorkView.as_view(), name='new_work'),
    url(r'^places/(?P<place_code>[a-z]{2}(-[^/]+)?)/works/new-batch/$', works.BatchAddWorkView.as_view(), name='new_batch_work'),
