...
class ContributorBadge(PermissionBadge):
    ...
    permissions = ('indigo_api.view_work', 'indigo_api.add_annotation', 'indigo_api.change_annotation', 'indigo_api.delete_annotation', 'indigo_api.add_task')
...
class DrafterBadge(PermissionBadge):
    ...
    permissions = ('indigo_api.add_work', 'indigo_api.change_work', 'indigo_api.add_document', 'indigo_api.change_document', 'indigo_api.add_amendment', 'indigo_api.change_amendment', 'indigo_api.delete_amendment', 'indigo_api.submit_task', 'indigo_api.reopen_task')
...
class SeniorDrafterBadge(PermissionBadge):
    ...
    permissions = ('indigo_api.delete_work', 'indigo_api.review_work', 'indigo_api.review_document', 'indigo_api.delete_document', 'indigo_api.cancel_task', 'indigo_api.unsubmit_task', 'indigo_api.resubmit_task', 'indigo_api.close_task')
