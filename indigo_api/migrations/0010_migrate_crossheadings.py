...
def forwards(apps, schema_editor):
    ...
    for doc in Document.objects.using('direct').order_by('-pk').iterator(100):
    ...
    for version in Version.objects.using('direct').get_for_model(Document).order_by('-pk').iterator(100):
